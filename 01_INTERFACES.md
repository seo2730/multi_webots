...
| `/{ns}/goal_pose` | `geometry_msgs/msg/PoseStamped` | **explorer**(`frontier_allocator`, 선택) | 전역 지도에서 뽑은 프론티어를 로봇별로 **배정**한 결과. ⚠️ [10장 ⑬](10_MAP_MERGE.md#⑬-탐사-커버리지가-20-언저리에서-평평해진다--경유점이-제자리로-뭉개진-것) |
