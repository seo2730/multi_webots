...
| **[12. 탐사 할당 (거리 ↔ LLM)](12_TASK_ALLOCATION.md)** | 전역 지도에서 뽑은 프론티어를 로봇에게 **배정**하기. 거리 기준 베이스라인과 LLM 을 같은 관측으로 비교 | 다중 로봇 탐사를 돌릴 때, **임무계획 증류**를 준비할 때 |
| **[13. 임무계획 지식 증류](13_DISTILLATION.md)** | 교사 LLM 의 판단을 작은 모델로 옮기기 — 데이터 수집 → 학습 → 평가 → 서빙 → 할당기에 꽂기 | 느린 교사를 대체할 때 |
...
> 근거는 [06장](06_SPOT_DRIVER.md#cmd_vel-단위--2026-08-16-변경), 튜닝 전 과정은 [07장](07_SPOT_NAV.md).
